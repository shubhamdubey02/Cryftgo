...
//
//	mockgen -package=snowmanmock -destination=snow/consensus/snowman/snowmanmock/block.go -mock_names=Block=Block github.com/shubhamdubey02/cryftgo/snow/consensus/snowman Block
//
