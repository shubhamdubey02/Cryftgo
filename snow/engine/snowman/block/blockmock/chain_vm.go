...
//
//	mockgen -package=blockmock -destination=snow/engine/snowman/block/blockmock/chain_vm.go -mock_names=ChainVM=ChainVM github.com/shubhamdubey02/cryftgo/snow/engine/snowman/block ChainVM
//
