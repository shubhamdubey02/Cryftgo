...
//
//	mockgen -package=filesystemmock -destination=utils/filesystem/filesystemmock/reader.go -mock_names=Reader=Reader github.com/shubhamdubey02/cryftgo/utils/filesystem Reader
//
