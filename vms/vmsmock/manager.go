...
// Source: github.com/shubhamdubey02/cryftgo/vms (interfaces: Manager)
//
// Generated by this command:
//
//	mockgen -package=vmsmock -destination=vms/vmsmock/manager.go -mock_names=Manager=Manager github.com/shubhamdubey02/cryftgo/vms Manager
//
