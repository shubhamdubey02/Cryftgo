...
//
//	mockgen -package=statemock -destination=vms/proposervm/state/statemock/state.go -mock_names=State=State github.com/shubhamdubey02/cryftgo/vms/proposervm/state State
//
