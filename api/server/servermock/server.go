...
// Source: github.com/shubhamdubey02/cryftgo/api/server (interfaces: Server)
//
// Generated by this command:
//
//	mockgen -package=servermock -destination=api/server/servermock/server.go -mock_names=Server=Server github.com/shubhamdubey02/cryftgo/api/server Server
//
